...
import sys
sys.path.append('/home/elon/Pycharm/ThreeD-Visual')
sys.path.append('/home/elon/Pycharm/ThreeD-Visual/models/monoscene')
...
class Downsample(nn.Module):
    def __init__(self, feature, norm_layer, bn_momentum, expansion=4):
